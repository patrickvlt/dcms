(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('rome')) :
    ...
    var DateTimePicker = function (_Events) {
        ...
        createClass(DateTimePicker, [{
            ...
            value: function setDate(date) {
                var dcmsDate = window.DCMS.moment((new Date(date))).locale(window.DCMS.language);
                var m = dcmsDate;
                var month = dcmsDate.format('MMM');
                var day = dcmsDate.format('D');
                var dayOfWeek = dcmsDate.format('dddd');
                var year = dcmsDate.format('YYYY');
