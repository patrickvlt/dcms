            ...
            (t = KTUtil.getById(a)) && (n = 300, void 0 !== KTLayoutHeader && (n = KTLayoutHeader.getHeight()), (e = new KTCard(t, {
                sticky: {
                    ...
                    position: {
                        top: function () {
                            var t = 0;
                            return KTUtil.getBody(), KTUtil.isBreakpointUp("lg") ? (void 0 !== KTLayoutHeader && KTLayoutHeader.isFixed() && (t += 70), void 0 !== KTLayoutSubheader && KTLayoutSubheader.isFixed() && (t += KTLayoutSubheader.getHeight())) : void 0 !== KTLayoutHeader && KTLayoutHeader.isFixedForMobile() && (t += KTLayoutHeader.getHeightForMobile()), t - 1
                        },
                        left: function (e) {
