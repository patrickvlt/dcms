                            ...
                            <form method="get" class="quick-search-form">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                                            <i class="quick-search-close fas fa-times text-muted"></i>
                                        </span>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300"
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold">Finance report has been generated
                                                    </div>
        ...
        <div class="container">
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu"
                    ...
                    <!--begin::Header Nav-->
                    <ul class="menu-nav">
                        <li class="menu-item @if(CurrentRoute() == 'dcms.portal.dashboard') menu-item-active @endif" aria-haspopup="true">
                ...
                <div class="quick-search quick-search-inline ml-4 w-250px" id="kt_quick_search_inline">
                    ...
                    <form method="get" class="quick-search-form">
                        <div class="input-group rounded">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <i class="quick-search-close fas fa-times"></i>
                                </span>
                            </div>
                        </div>
                    </form>
