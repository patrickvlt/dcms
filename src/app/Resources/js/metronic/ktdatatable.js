		...
		var Plugin = {
			...
			filterArray: function(list, args, operator) {
				...
				$.each(list, function(key, obj) {
					...
					var matched = 0;
					$.each(args, function(m_key, filterValue) {
						filterValue = filterValue instanceof Array ? filterValue : [filterValue];
						var recordValue = Plugin.getObject(m_key, to_match);
						if (typeof recordValue !== 'undefined' && recordValue) {
                            var recordValueToString = recordValue.toString().toLowerCase();
