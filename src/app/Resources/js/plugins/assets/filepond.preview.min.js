                        ...
                        if (n) {
                            ...
                            if (!y || y && p) {
                                var v, I = d / h,
                                    M = f / u;
                                if ("force" === g) h = d, u = f;
                                else "cover" === g ? v = Math.max(I, M) : "contain" === g && (v = Math.min(I, M)), h *= v, u *= v
                            }
                        }
                        var x = {
                            width: c,
            ...
            return e.utils.createView({
                ...
                write: e.utils.createRoute({
                    ...
                    DID_FINISH_CALCULATE_PREVIEWSIZE: function (e) {
                        ...
                        if (c) {
                            var s, h, u = URL.createObjectURL(c.file),
                                l = function () {
                                    var e;
                            ...
                            if (s = c.file, !(((h = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./)) ? parseInt(h[1]) : null) <= 58) && "createImageBitmap" in window && W(s)) {
                                var f = r(b);
                                f.post({
                                    file: c.file
                                }, function (e) {
