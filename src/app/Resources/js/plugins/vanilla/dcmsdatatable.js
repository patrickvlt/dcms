...
window.DCMS.mergeColumns = function (row, column) {
    var value = '';
...
window.DCMS.datatable = function (parameters) {
    $(document).ready(function () {
        ...
        let defaultWithGlobalProperties = (typeof window.DCMS.datatable.config !== 'undefined') ? Object.assign(defaultProperties, window.DCMS.datatable.config) : defaultProperties;
        ...
        $($(table).data('kt-parent')).find('[data-kt-action="reload"]').on('click', function () {
            if (window.DCMS.datatable.beforeRefresh) {
                window.DCMS.datatable.beforeRefresh();
            }
        ...
        window.DCMS.datatable.allowMoreOn = [];
        window.DCMS.datatable.allowLessOn = [];
        window.DCMS.datatable.forceExactOn = [];
            ...
            $(filter).on('change', function (filter) {
                ...
                if (!filter.currentTarget.dataset.ktFilterCustom) {
                    ...
                    if (filter.currentTarget.type !== 'checkbox') {
                        if (filter.currentTarget.dataset.ktAllowMore == 'true' && !window.DCMS.datatable.allowMoreOn.includes(filter.currentTarget.dataset.ktFilter))
                            window.DCMS.datatable.allowMoreOn.push(filter.currentTarget.dataset.ktFilter);
                        if (filter.currentTarget.dataset.ktAllowLess == 'true' && !window.DCMS.datatable.allowLessOn.includes(filter.currentTarget.dataset.ktFilter))
                            window.DCMS.datatable.allowLessOn.push(filter.currentTarget.dataset.ktFilter);
                        if (filter.currentTarget.dataset.ktForceExact == 'true' && !window.DCMS.datatable.forceExactOn.includes(filter.currentTarget.dataset.ktFilter))
                            window.DCMS.datatable.forceExactOn.push(filter.currentTarget.dataset.ktFilter);
                        if (!filter.currentTarget.dataset.ktFilterCustom)
        ...
        $(document).on('click', 'table [data-kt-action=destroy]', function (e) {
            ...
            window.DCMS.deleteModel({
                ...
                completeMsg: (table.dataset.ktDeleteSingleCompleteMessage) ? Lang(table.dataset.ktDeleteSingleCompleteMessage) : Lang('The object has been successfully deleted.'),
