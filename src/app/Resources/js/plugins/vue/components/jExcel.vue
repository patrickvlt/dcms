     ...
     window
      ...
      .then(function (response) {
       Swal.fire({
        ...
        icon: "warning",
        confirmButtonColor: typeof (
         window.DCMS.sweetAlert.confirmButtonColor !== "undefined"
        )
         ? window.DCMS.sweetAlert.confirmButtonColor
         : "var(--primary)",
        confirmButtonText: typeof (
         window.DCMS.sweetAlert.confirmButtonText !== "undefined"
        )
         ? window.DCMS.sweetAlert.confirmButtonText
         : Lang("OK"),
        cancelButtonColor: typeof (
         window.DCMS.sweetAlert.cancelButtonColor !== "undefined"
        )
         ? window.DCMS.sweetAlert.cancelButtonColor
         : "var(--dark)",
        cancelButtonText: typeof (
         window.DCMS.sweetAlert.cancelButtonText !== "undefined"
        )
         ? window.DCMS.sweetAlert.cancelButtonText
         : Lang("Cancel"),
